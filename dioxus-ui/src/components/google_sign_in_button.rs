...
/// Official Google Identity Services (GSI) Material button — dark theme.
///
/// Renders the multi-color "G" logo alongside "Sign in with Google" using
/// Google's prescribed markup and CSS classes.
#[component]
