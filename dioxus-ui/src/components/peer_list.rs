                ...
                div { class: "attendants-section",
                    ...
                    div { class: "peer-list",
                        ul {
                            ...
                            li { PeerListItem { name: display_name.clone(), is_host: is_current_user_host, is_self: true, muted: self_muted, speaking: self_speaking, on_edit_name: on_edit_self_name } }
