  ...
  return (
    <Dialog.Root open={bot !== null} onOpenChange={(o) => !o && onClose()}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 z-50 w-[min(90vw,440px)] -translate-x-1/2 -translate-y-1/2 rounded-lg border border-neutral-200 bg-white p-6 shadow-xl focus:outline-none">
          ...
          <div className="mt-5 flex justify-end gap-2">
            ...
            <button
              type="button"
              onClick={submit}
              className="rounded-md bg-sky-500 px-3 py-1.5 text-sm font-medium text-white shadow-sm hover:bg-sky-600"
            >
