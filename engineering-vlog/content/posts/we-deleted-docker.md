...
Docker survives for exactly two jobs, both optional: running the production images locally (`make up`) and the Playwright e2e stack. Neither is in your edit-compile-test loop.
