            ...
            <div class="max-w-4xl mx-auto relative z-10">
                <div class="flex flex-col md:flex-row justify-between items-center mb-12">
                    ...
                    <nav class="w-full md:w-auto">
                        <ul class="grid grid-cols-2 sm:grid-cols-3 md:flex md:flex-row gap-x-10 gap-y-6 text-foreground-muted">
                            ...
                            <li>
                                <a href="https://github.com/security-union/videocall-rs" class="relative hover:text-foreground transition-colors group block">
                ...
                <div class="pt-8 flex flex-col md:flex-row justify-between items-center relative">
                    ...
                    <div class="flex gap-6">
                        <a href="https://github.com/security-union/videocall-rs/blob/main/LICENSE-MIT" class="text-foreground-subtle hover:text-foreground transition-colors text-sm relative group">
