        ...
        <Page>
            ...
            <div class="w-full flex justify-center pb-16">
                <a
                    ...
                    class="group relative px-8 py-4 rounded-xl bg-gradient-to-r from-primary to-primary hover:from-primary hover:to-secondary text-white font-bold text-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.03] active:scale-[0.97] border-2 border-white/20"
                >
                    {/* Top accent line */}
                    <div class="absolute top-0 left-0 w-full h-1 bg-white/30 rounded-t-xl"></div>
                    
                    {/* Button content */}
                    <div class="flex items-center justify-center">
                        <svg class="w-8 h-8 mr-3 transition-transform duration-300 group-hover:scale-125" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
