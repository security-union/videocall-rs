...
public protocol WebTransportClientProtocol: AnyObject, Sendable {
    ...
    func sendDatagram(data: [UInt8]) throws  -> [UInt8]
...
public convenience init(url: String) {
    let pointer =
        try! rustCall() {
    uniffi_videocall_ios_fn_constructor_webtransportclient_new(
...
open func connect()throws   {try rustCallWithError(FfiConverterTypeWebTransportError_lift) {
    uniffi_videocall_ios_fn_method_webtransportclient_connect(self.uniffiClonePointer(),$0
    )
}
}
    
open func sendDatagram(data: [UInt8])throws  -> [UInt8]  {
...
public struct FfiConverterTypeWebTransportError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> WebTransportError {
        ...
        case 4: return .HttpError(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 5: return .TlsError(
            message: try FfiConverterString.read(from: &buf)
        )
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_videocall_ios_checksum_method_webtransportclient_connect() != 22795) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_videocall_ios_checksum_method_webtransportclient_send_datagram() != 34480) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_videocall_ios_checksum_constructor_webtransportclient_new() != 46891) {
        return InitializationResult.apiChecksumMismatch
    }
