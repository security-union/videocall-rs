...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_videocall_uniffi_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_videocall_uniffi_rustbuffer_free(self, $0) }
    }
}
...
private func makeRustCall<T, E: Swift.Error>(
    ...
    uniffiEnsureVideocallUniffiInitialized()
...
open class DatagramQueue: DatagramQueueProtocol, @unchecked Sendable {
    ...
    public func uniffiClonePointer() -> UnsafeMutableRawPointer {
        return try! rustCall { uniffi_videocall_uniffi_fn_clone_datagramqueue(self.pointer, $0) }
    }
public convenience init() {
    let pointer =
        try! rustCall() {
    uniffi_videocall_uniffi_fn_constructor_datagramqueue_new($0
    )
}
    ...
    deinit {
        ...
        try! rustCall { uniffi_videocall_uniffi_fn_free_datagramqueue(pointer, $0) }
    }
...
open func addDatagram(data: [UInt8])throws   {try rustCallWithError(FfiConverterTypeWebTransportError_lift) {
    uniffi_videocall_uniffi_fn_method_datagramqueue_add_datagram(self.uniffiClonePointer(),
...
open func hasDatagrams()throws  -> Bool  {
    ...
    uniffi_videocall_uniffi_fn_method_datagramqueue_has_datagrams(self.uniffiClonePointer(),$0
    )
})
}
...
open func receiveDatagram()throws  -> [UInt8]  {
    ...
    uniffi_videocall_uniffi_fn_method_datagramqueue_receive_datagram(self.uniffiClonePointer(),$0
    )
})
}
...
#endif
    public func uniffiClonePointer() -> UnsafeMutableRawPointer {
        return try! rustCall { uniffi_videocall_uniffi_fn_clone_webtransportclient(self.pointer, $0) }
    }
public convenience init() {
    let pointer =
        try! rustCall() {
    uniffi_videocall_uniffi_fn_constructor_webtransportclient_new($0
    )
}
    self.init(unsafeFromRawPointer: pointer)
}
    ...
    deinit {
        ...
        try! rustCall { uniffi_videocall_uniffi_fn_free_webtransportclient(pointer, $0) }
    }
...
open func connect(url: String)throws   {try rustCallWithError(FfiConverterTypeWebTransportError_lift) {
    uniffi_videocall_uniffi_fn_method_webtransportclient_connect(self.uniffiClonePointer(),
...
open func sendDatagram(data: [UInt8])throws   {try rustCallWithError(FfiConverterTypeWebTransportError_lift) {
    uniffi_videocall_uniffi_fn_method_webtransportclient_send_datagram(self.uniffiClonePointer(),
        FfiConverterSequenceUInt8.lower(data),$0
    )
}
}
...
open func stopDatagramListener()throws   {try rustCallWithError(FfiConverterTypeWebTransportError_lift) {
    uniffi_videocall_uniffi_fn_method_webtransportclient_stop_datagram_listener(self.uniffiClonePointer(),$0
    )
}
}
    
open func subscribeToDatagrams(queue: DatagramQueue)throws   {try rustCallWithError(FfiConverterTypeWebTransportError_lift) {
    uniffi_videocall_uniffi_fn_method_webtransportclient_subscribe_to_datagrams(self.uniffiClonePointer(),
...
public func getVersion() -> String  {
    ...
    uniffi_videocall_uniffi_fn_func_get_version($0
    )
})
}
public func helloWorld() -> String  {
    return try!  FfiConverterString.lift(try! rustCall() {
    uniffi_videocall_uniffi_fn_func_hello_world($0
    )
})
}
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_videocall_uniffi_uniffi_contract_version()
    if bindings_contract_version != scaffolding_contract_version {
        return InitializationResult.contractVersionMismatch
    }
    if (uniffi_videocall_uniffi_checksum_func_get_version() != 3011) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_videocall_uniffi_checksum_func_hello_world() != 58223) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_videocall_uniffi_checksum_method_datagramqueue_add_datagram() != 26138) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_videocall_uniffi_checksum_method_datagramqueue_has_datagrams() != 65446) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_videocall_uniffi_checksum_method_datagramqueue_receive_datagram() != 6952) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_videocall_uniffi_checksum_method_webtransportclient_connect() != 40856) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_videocall_uniffi_checksum_method_webtransportclient_send_datagram() != 43530) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_videocall_uniffi_checksum_method_webtransportclient_stop_datagram_listener() != 1641) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_videocall_uniffi_checksum_method_webtransportclient_subscribe_to_datagrams() != 1320) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_videocall_uniffi_checksum_constructor_datagramqueue_new() != 18332) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_videocall_uniffi_checksum_constructor_webtransportclient_new() != 4394) {
        return InitializationResult.apiChecksumMismatch
    }
...
public func uniffiEnsureVideocallUniffiInitialized() {
