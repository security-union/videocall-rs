...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ENTRY_AUDIO\x10\x02\x12\x10\n\x0cENTRY_SCREEN\x10\x03J\x95%\n\x06\x12\
    \x04\0\0S\x01\n\x08\n\x01\x0c\x12\x03\0\0\x12\n\xfd\x11\n\x02\x04\0\x12\
    \x04'\0S\x01\x1a\xf0\x11\x20Client\x20->\x20relay\x20simulcast\x20layer-\
    ...
    \x20purely\x20for\x20simulcast\x20layer-drop\x20decisions.\x20It\x20can\
    \x20only\x20reduce\x20what\x20an\n\x20already-authorized\x20session\x20r\
    eceives;\x20it\x20never\x20grants\x20access.\x20No\x20recorded\n\x20pref\
    erence\x20(or\x20no\x20LAYER_PREFERENCE\x20packet\x20at\x20all)\x20means\
    \x20\"no\x20layer\x20signal\"\n\x20and\x20the\x20relay\x20forwards\x20ev\
    ery\x20layer\x20(fail-open\x20to\x20pre-#989\x20behaviour).\x20The\n\x20\
    relay\x20does\x20NOT\x20validate\x20that\x20the\x20requested\x20layer\
    \x20is\x20actually\x20being\x20produced\n\x20by\x20the\x20source:\x20a\
    \x20client\x20requesting\x20an\x20absent\x20layer\x20black-tiles\x20ITSE\
    LF;\x20the\n\x20client-side\x20clamp\x20(only\x20request\x20observed-arr\
    iving\x20layers)\x20is\x20the\x20mitigation\n\x20and\x20is\x20a\x20separ\
    ate\x20frontend\x20increment.\x20As\x20of\x20Phase\x203\x20the\x20relay\
    \x20filters\x20ALL\n\x20filterable\x20kinds\x20\xe2\x80\x94\x20VIDEO,\
    \x20SCREEN,\x20AND\x20AUDIO\x20\xe2\x80\x94\x20per\x20(source,\x20media_\
    kind)\x20(see\n\x20EntryMediaKind\x20and\x20the\x20per-kind\x20notes\x20\
    on\x20Entry\x20below);\x20the\x20base\x20layer\n\x20(layer\x200)\x20is\
    \x20always\x20forwarded\x20regardless\x20of\x20kind.\x20This\x20packet\
    \x20is\x20consumed\x20by\n\x20the\x20relay\x20and\x20never\x20re-broadca\
    st.\n\n\n\n\x03\x04\0\x01\x12\x03'\x08\x1d\n\xf3\x04\n\x04\x04\0\x04\0\
    \x12\x042\x027\x03\x1a\xe4\x04\x20The\x20media\x20kind\x20an\x20Entry\
    \x20applies\x20to\x20(issue\x20#989,\x20Phase\x203).\x20Mirrors\n\x20`Pa\
    cketWrapper.MediaKind`\x20so\x20camera\x20VIDEO,\x20AUDIO,\x20and\x20SCR\
    EEN\x20of\x20the\x20SAME\n\x20source\x20session\x20can\x20be\x20addresse\
    d\x20INDEPENDENTLY:\x20a\x20receiver\x20can\x20request\x20a\n\x20low\x20\
    SCREEN\x20layer\x20while\x20keeping\x20full\x20camera\x20VIDEO,\x20etc.\
    \n\n\x20BACK-COMPAT:\x20the\x20default\x20(UNSPECIFIED\x20=\x200)\x20MUS\
    T\x20be\x20treated\x20by\x20the\x20relay\x20as\n\x20VIDEO.\x20Pre-Phase-\
    3\x20clients\x20omit\x20this\x20field\x20(proto3\x20default\x200),\x20an\
    d\x20before\n\x20Phase\x203\x20the\x20relay\x20only\x20ever\x20filtered\
    \x20VIDEO\x20\xe2\x80\x94\x20so\x20an\x20absent\x20media_kind\x20is\n\
    \x20exactly\x20\"this\x20entry\x20is\x20about\x20the\x20source's\x20came\
    ra\x20video\",\x20preserving\x20the\n\x20existing\x20wire\x20contract\
    \x20with\x20no\x20flag-day.\n\n\x0c\n\x05\x04\0\x04\0\x01\x12\x032\x07\
    \x15\n.\n\x06\x04\0\x04\0\x02\0\x12\x033\x04%\"\x1f\x20treated\x20as\x20\
    VIDEO\x20by\x20the\x20relay\n\n\x0e\n\x07\x04\0\x04\0\x02\0\x01\x12\x033\
    \x04\x20\n\x0e\n\x07\x04\0\x04\0\x02\0\x02\x12\x033#$\n\r\n\x06\x04\0\
    \x04\0\x02\x01\x12\x034\x04\x14\n\x0e\n\x07\x04\0\x04\0\x02\x01\x01\x12\
    \x034\x04\x0f\n\x0e\n\x07\x04\0\x04\0\x02\x01\x02\x12\x034\x12\x13\n\r\n\
    \x06\x04\0\x04\0\x02\x02\x12\x035\x04\x14\n\x0e\n\x07\x04\0\x04\0\x02\
    \x02\x01\x12\x035\x04\x0f\n\x0e\n\x07\x04\0\x04\0\x02\x02\x02\x12\x035\
    \x12\x13\n\r\n\x06\x04\0\x04\0\x02\x03\x12\x036\x04\x15\n\x0e\n\x07\x04\
    \0\x04\0\x02\x03\x01\x12\x036\x04\x10\n\x0e\n\x07\x04\0\x04\0\x02\x03\
    \x02\x12\x036\x13\x14\n\x86\x01\n\x04\x04\0\x03\0\x12\x04;\x02N\x03\x1ax\
    \x20One\x20desired-layer\x20entry:\x20for\x20a\x20given\x20source\x20ses\
    sion\x20AND\x20media\x20kind,\x20the\n\x20simulcast\x20layer\x20the\x20r\
    eceiver\x20wants\x20forwarded.\n\n\x0c\n\x05\x04\0\x03\0\x01\x12\x03;\n\
    \x0f\n\xce\x01\n\x06\x04\0\x03\0\x02\0\x12\x03?\x04\x1a\x1a\xbe\x01\x20T\
    he\x20source\x20session_id\x20(publisher)\x20this\x20preference\x20appli\
    es\x20to.\x20This\x20is\n\x20the\x20SUBJECT-derived\x20publisher\x20sess\
    ion\x20the\x20relay\x20matches\x20against\x20on\x20the\n\x20forwarding\
    \x20path,\x20NOT\x20a\x20forgeable\x20inner\x20field.\n\n\x0e\n\x07\x04\
    \0\x03\0\x02\0\x05\x12\x03?\x04\n\n\x0e\n\x07\x04\0\x03\0\x02\0\x01\x12\
    \x03?\x0b\x15\n\x0e\n\x07\x04\0\x03\0\x02\0\x03\x12\x03?\x18\x19\n\xe9\
    \x02\n\x06\x04\0\x03\0\x02\x01\x12\x03E\x04\x1d\x1a\xd9\x02\x20The\x20si\
    mulcast\x20layer\x20the\x20receiver\x20wants\x20from\x20`session_id`.\
    \x20Matched\n\x20against\x20the\x20cleartext\x20`PacketWrapper.simulcast\
    _layer_id`\x20(field\x205).\n\x200\x20=\x20BASE\x20LAYER\x20ONLY\x20(dro\
    p\x20upgraded\x20layers\x20from\x20this\x20source),\x20NOT\x20\"no\n\x20\
    preference\"\x20\xe2\x80\x94\x20to\x20express\x20\"no\x20preference\x20/\
    \x20forward\x20all\",\x20omit\x20the\x20entry\n\x20for\x20this\x20source\
    \x20entirely\x20(see\x20the\x20message-level\x20comment\x20above).\n\n\
    \x0e\n\x07\x04\0\x03\0\x02\x01\x05\x12\x03E\x04\n\n\x0e\n\x07\x04\0\x03\
    \0\x02\x01\x01\x12\x03E\x0b\x18\n\x0e\n\x07\x04\0\x03\0\x02\x01\x03\x12\
    \x03E\x1b\x1c\n\x8d\x04\n\x06\x04\0\x03\0\x02\x02\x12\x03M\x04\"\x1a\xfd\
    \x03\x20Which\x20media\x20kind\x20of\x20`session_id`\x20this\x20entry\
    \x20constrains\x20(issue\x20#989,\n\x20Phase\x203).\x20Additive\x20field\
    ;\x20default\x200\x20(UNSPECIFIED)\x20=\x20VIDEO\x20for\x20back-compat\n\
    \x20(see\x20EntryMediaKind).\x20The\x20relay\x20keys\x20its\x20per-recei\
    ver\x20preference\x20map\x20by\n\x20(session_id,\x20media_kind),\x20and\
    \x20matches\x20an\x20entry\x20against\x20a\x20forwarded\n\x20packet's\
    \x20cleartext\x20`PacketWrapper.media_kind`.\x20AUDIO/SCREEN\x20entries\
    \x20are\n\x20ignored\x20by\x20pre-Phase-3\x20relays\x20(which\x20only\
    \x20filter\x20VIDEO),\x20so\x20an\x20old\x20relay\n\x20simply\x20forward\
    s\x20those\x20streams\x20unfiltered\x20\xe2\x80\x94\x20fail-open,\x20nev\
    er\x20a\x20wrong\x20drop.\n\n\x0e\n\x07\x04\0\x03\0\x02\x02\x06\x12\x03M\
    \x04\x12\n\x0e\n\x07\x04\0\x03\0\x02\x02\x01\x12\x03M\x13\x1d\n\x0e\n\
    \x07\x04\0\x03\0\x02\x02\x03\x12\x03M\x20!\nh\n\x04\x04\0\x02\0\x12\x03R\
    \x02\x1d\x1a[\x20Per-(source,\x20media-kind)\x20desired-layer\x20entries\
    .\x20Empty\x20=\x20no\x20layer\n\x20constraint\x20(fail-open).\n\n\x0c\n\
    \x05\x04\0\x02\0\x04\x12\x03R\x02\n\n\x0c\n\x05\x04\0\x02\0\x06\x12\x03R\
    \x0b\x10\n\x0c\n\x05\x04\0\x02\0\x01\x12\x03R\x11\x18\n\x0c\n\x05\x04\0\
    \x02\0\x03\x12\x03R\x1b\x1cb\x06proto3\
";
