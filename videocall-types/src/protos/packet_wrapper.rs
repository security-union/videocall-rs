...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1atypes/packet_wrapper.proto\"\xbe\x04\n\rPacketWrapper\x12:\n\x0bpa\
    ...
    \t\n\x05AUDIO\x10\x02\x12\n\n\x06SCREEN\x10\x03J\x9a\x20\n\x06\x12\x04\0\
    \0N\x01\n\x08\n\x01\x0c\x12\x03\0\0\x12\n\n\n\x02\x04\0\x12\x04\x02\0N\
    ...
    \x02\x12\x03\x0e\x11\x13\n\xa0\x02\n\x06\x04\0\x04\0\x02\x0b\x12\x03\x13\
    \x04\x12\x1a\x90\x02\x20Client\x20->\x20relay\x20ONLY\x20control\x20pack\
    et.\x20Carries\x20the\x20set\x20of\x20session_ids\n\x20the\x20sender\x20\
    is\x20currently\x20rendering\x20(its\x20viewport\x20/\x20\"desired\x20st\
    reams\"\n\x20set).\x20The\x20relay\x20consumes\x20this\x20to\x20filter\
    \x20VIDEO\x20it\x20forwards\x20downstream\n\x20(see\x20ViewportPacket).\
    \x20It\x20is\x20never\x20re-broadcast\x20to\x20other\x20peers.\n\n\x0e\n\
    \x07\x04\0\x04\0\x02\x0b\x01\x12\x03\x13\x04\x0c\n\x0e\n\x07\x04\0\x04\0\
    \x02\x0b\x02\x12\x03\x13\x0f\x11\n\xf1\x03\n\x06\x04\0\x04\0\x02\x0c\x12\
    \x03\x1b\x04\x1a\x1a\xe1\x03\x20Client\x20->\x20relay\x20ONLY\x20control\
    \x20packet\x20(#989,\x20Phase\x201b).\x20Carries\x20the\n\x20per-sender\
    \x20simulcast\x20layer\x20each\x20receiver\x20wants\x20the\x20relay\x20t\
    o\x20forward\n\x20(its\x20\"layer\x20preferences\").\x20The\x20relay\x20\
    consumes\x20this\x20to\x20drop\x20simulcast\n\x20VIDEO\x20layers\x20the\
    \x20receiver\x20did\x20not\x20select\x20(see\x20LayerPreferencePacket).\
    \n\x20It\x20is\x20never\x20re-broadcast\x20to\x20other\x20peers,\x20and\
    \x20\xe2\x80\x94\x20like\x20VIEWPORT\x20\xe2\x80\x94\x20it\x20is\n\x20re\
    corded\x20ONLY\x20when\x20it\x20arrives\x20on\x20the\x20receiver's\x20ow\
    n\x20NATS\x20subject,\x20so\x20a\n\x20forged\x20payload\x20only\x20self-\
    degrades\x20the\x20forger's\x20OWN\x20view.\n\n\x0e\n\x07\x04\0\x04\0\
    \x02\x0c\x01\x12\x03\x1b\x04\x14\n\x0e\n\x07\x04\0\x04\0\x02\x0c\x02\x12\
    \x03\x1b\x17\x19\n\x8c\n\n\x06\x04\0\x04\0\x02\r\x12\x030\x04\x14\x1a\
    \xfc\t\x20Relay\x20->\x20publisher\x20ONLY\x20control\x20packet\x20(#110\
    8,\x20Stage\x203).\x20This\x20is\x20the\n\x20mirror\x20image\x20of\x20LA\
    YER_PREFERENCE:\x20where\x20LAYER_PREFERENCE\x20flows\x20UP\x20from\x20a\
    \n\x20receiver\x20to\x20constrain\x20what\x20the\x20relay\x20FORWARDS,\
    \x20LAYER_HINT\x20flows\x20DOWN\x20from\n\x20the\x20relay\x20to\x20a\x20\
    single\x20publisher\x20to\x20hint\x20what\x20it\x20should\x20bother\x20E\
    NCODING.\n\x20The\x20relay\x20computes,\x20per\x20source,\x20the\x20UNIO\
    N\x20(max)\x20of\x20every\x20receiver's\n\x20requested\x20layer\x20for\
    \x20that\x20source\x20and,\x20when\x20NO\x20receiver\x20wants\x20a\x20gi\
    ven\x20upper\n\x20layer,\x20hints\x20the\x20publisher\x20to\x20stop\x20p\
    roducing\x20it\x20(publish-side\n\x20suppression).\x20See\x20LayerHintPa\
    cket.\n\n\x20TRUST\x20BOUNDARY\x20(security-critical,\x20inverse\x20of\
    \x20LAYER_PREFERENCE):\x20this\n\x20packet\x20is\x20RELAY-AUTHORED\x20an\
    d\x20travels\x20relay\x20->\x20publisher\x20ONLY.\x20It\x20is\n\x20deliv\
    ered\x20on\x20the\x20publisher's\x20OWN\x20per-session\x20NATS\x20subjec\
    t\n\x20(room.{room}.{publisher_session})\x20exactly\x20like\x20the\x20se\
    rver-authored\n\x20CONGESTION\x20self-packet.\x20The\x20relay\x20NEVER\
    \x20accepts\x20a\x20LAYER_HINT\x20from\x20a\n\x20client:\x20there\x20is\
    \x20no\x20inbound\x20LAYER_HINT\x20ingest\x20path,\x20no\n\x20try_interc\
    ept_layer_hint,\x20and\x20no\x20handler\x20that\x20records\x20or\x20acts\
    \x20on\x20a\n\x20LAYER_HINT\x20arriving\x20on\x20a\x20session\x20subject\
    .\x20A\x20client\x20that\x20forges\x20one\x20only\n\x20sends\x20bytes\
    \x20the\x20relay\x20drops\x20on\x20the\x20floor.\x20The\x20hint\x20is\
    \x20purely\x20ADVISORY\x20\xe2\x80\x94\n\x20the\x20publisher\x20clamps\
    \x20it\x20against\x20its\x20own\x20real\x20ladder\x20and\x20a\x20missing\
    /garbage\n\x20hint\x20simply\x20means\x20\"encode\x20the\x20full\x20ladd\
    er\"\x20(fail-open).\n\n\x0e\n\x07\x04\0\x04\0\x02\r\x01\x12\x030\x04\
    \x0e\n\x0e\n\x07\x04\0\x04\0\x02\r\x02\x12\x030\x11\x13\n\xa7\x05\n\x04\
    \x04\0\x04\x01\x12\x04?\x02D\x03\x1a\x98\x05\x20Cleartext\x20media-kind\
    \x20discriminator\x20on\x20the\x20OUTER\x20envelope.\n\n\x20Under\x20E2E\
    E_ENABLED=true\x20the\x20inner\x20MediaPacket\x20(including\x20its\x20ow\
    n\n\x20`media_type`)\x20is\x20AES-sealed,\x20so\x20the\x20relay\x20\xe2\
    \x80\x94\x20which\x20never\x20decrypts\x20\xe2\x80\x94\n\x20cannot\x20te\
    ll\x20VIDEO\x20from\x20AUDIO/SCREEN.\x20This\x20field\x20lets\x20the\x20\
    publisher\n\x20advertise\x20the\x20media\x20kind\x20in\x20cleartext\x20s\
    o\x20the\x20relay\x20can\x20apply\n\x20viewport-aware\x20VIDEO\x20filter\
    ing\x20while\x20ALWAYS\x20forwarding\x20AUDIO.\n\n\x20Set\x20only\x20by\
    ...
    \x12\x03@\x1d\x1e\n\r\n\x06\x04\0\x04\x01\x02\x01\x12\x03A\x04\x0e\n\x0e\
    \n\x07\x04\0\x04\x01\x02\x01\x01\x12\x03A\x04\t\n\x0e\n\x07\x04\0\x04\
    \x01\x02\x01\x02\x12\x03A\x0c\r\n\r\n\x06\x04\0\x04\x01\x02\x02\x12\x03B\
    \x04\x0e\n\x0e\n\x07\x04\0\x04\x01\x02\x02\x01\x12\x03B\x04\t\n\x0e\n\
    \x07\x04\0\x04\x01\x02\x02\x02\x12\x03B\x0c\r\n\r\n\x06\x04\0\x04\x01\
    \x02\x03\x12\x03C\x04\x0f\n\x0e\n\x07\x04\0\x04\x01\x02\x03\x01\x12\x03C\
    \x04\n\n\x0e\n\x07\x04\0\x04\x01\x02\x03\x02\x12\x03C\r\x0e\n\x0b\n\x04\
    \x04\0\x02\0\x12\x03F\x02\x1d\n\x0c\n\x05\x04\0\x02\0\x06\x12\x03F\x02\
    \x0c\n\x0c\n\x05\x04\0\x02\0\x01\x12\x03F\r\x18\n\x0c\n\x05\x04\0\x02\0\
    \x03\x12\x03F\x1b\x1c\n\x0b\n\x04\x04\0\x02\x01\x12\x03G\x02\x14\n\x0c\n\
    \x05\x04\0\x02\x01\x05\x12\x03G\x02\x07\n\x0c\n\x05\x04\0\x02\x01\x01\
    \x12\x03G\x08\x0f\n\x0c\n\x05\x04\0\x02\x01\x03\x12\x03G\x12\x13\n\x0b\n\
    \x04\x04\0\x02\x02\x12\x03H\x02\x11\n\x0c\n\x05\x04\0\x02\x02\x05\x12\
    \x03H\x02\x07\n\x0c\n\x05\x04\0\x02\x02\x01\x12\x03H\x08\x0c\n\x0c\n\x05\
    \x04\0\x02\x02\x03\x12\x03H\x0f\x10\n\x0b\n\x04\x04\0\x02\x03\x12\x03I\
    \x02\x18\n\x0c\n\x05\x04\0\x02\x03\x05\x12\x03I\x02\x08\n\x0c\n\x05\x04\
    \0\x02\x03\x01\x12\x03I\t\x13\n\x0c\n\x05\x04\0\x02\x03\x03\x12\x03I\x16\
    \x17\nF\n\x04\x04\0\x02\x04\x12\x03K\x02\x20\x1a9\x20Simulcast\x20layer\
    \x20id\x20(#989/PR\x20#993);\x20see\x20discussion\x20#890.\n\n\x0c\n\x05\
    \x04\0\x02\x04\x05\x12\x03K\x02\x08\n\x0c\n\x05\x04\0\x02\x04\x01\x12\
    \x03K\t\x1b\n\x0c\n\x05\x04\0\x02\x04\x03\x12\x03K\x1e\x1f\n[\n\x04\x04\
    \0\x02\x05\x12\x03M\x02\x1b\x1aN\x20Cleartext\x20discriminator;\x20see\
    \x20MediaKind.\x20Default\x200\x20=\x20unspecified\x20=\x20fail-open.\n\
    \n\x0c\n\x05\x04\0\x02\x05\x06\x12\x03M\x02\x0b\n\x0c\n\x05\x04\0\x02\
    \x05\x01\x12\x03M\x0c\x16\n\x0c\n\x05\x04\0\x02\x05\x03\x12\x03M\x19\x1a\
    b\x06proto3\
";
