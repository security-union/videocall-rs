...
#[function_component(PeerIcon)]
pub fn peer_icon() -> Html {
    html! {
        <svg height="40px" width="40px" version="1.1" id="_x32_" xmlns={"http://www.w3.org/2000/svg"} xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
            <g>
